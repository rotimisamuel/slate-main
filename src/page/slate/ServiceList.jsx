...
import PortfolioCard from "./ServiceCard";
import BreadCrumb from "../../components/common/Breadcrumb";

import BreadCrumb1 from "../../components/common/Breadcrumb";
	...
	return (
		<div className="section aximo-project-page aximo-section-padding5">
			<div className="container">
				<div className="row">
					{serviceListData.map((portfolio, index) => (
						<FadeInStagger className="col-lg-6" key={portfolio.id} index={index}>
							<ServiceCard portfolio={portfolio} />
						</FadeInStagger>
					))}
				</div>
			</div>
